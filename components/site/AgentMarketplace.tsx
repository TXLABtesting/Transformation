'use client';
// ============================================================================
// «سوق المساعدين» — استكشاف مساعدي الذكاء الاصطناعي المساعد بحسب المسارات،
...
const AGENTS: Agent[] = [
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد جدولة الاجتماعات', by: 'سعيد النعيمي', feats: ['يجد الأوقات المناسبة عبر التقويمات', 'يحجز القاعات تلقائياً', 'يرسل الدعوات ويحدّثها'], rate: '4.2', sat: '94%', rev: 12 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد تلخيص الوثائق', by: 'أحمد المنصوري', feats: ['يلخّص التقارير الطويلة', 'يختصر سلاسل البريد', 'يقدّم موجزات دقيقة'], rate: '4.0', sat: '98%', rev: 26 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد صياغة البريد', by: 'مريم السويدي', feats: ['يصيغ بأسلوبك', 'بالعربية والإنجليزية', 'يحسّن حتى الاعتماد'], rate: '4.8', sat: '98%', rev: 16 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد التوظيف', by: 'فاطمة الزعابي', feats: ['يفرز طلبات التوظيف', 'يجدول المقابلات', 'يعدّ تقارير المرشحين'], rate: '4.5', sat: '96%', rev: 34 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد المشتريات', by: 'نورة القبيسي', feats: ['يعدّ طلبات الشراء', 'يقارن العروض', 'يتابع دورة الاعتماد'], rate: '4.6', sat: '97%', rev: 29 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد مراجعة العقود', by: 'لطيفة المزروعي', feats: ['يراجع بنود العقود', 'يرصد المخاطر القانونية', 'يقترح صياغات بديلة'], rate: '4.4', sat: '95%', rev: 19 },
  { cat: 'مسار العمل الحكومي الاستراتيجي', name: 'مساعد البيانات والتقارير', by: 'شمّا الحوسني', feats: ['يحوّل البيانات إلى رؤى', 'يولّد لوحات متابعة', 'يجيب بالأرقام'], rate: '4.5', sat: '96%', rev: 27 },
  { cat: 'مسار العمل الحكومي الاستراتيجي', name: 'مساعد تنظيم المهام', by: 'خالد الشامسي', feats: ['يلتقط بنود العمل من الاجتماعات', 'يرتّب الأولويات', 'يتابع الإنجاز'], rate: '4.4', sat: '95%', rev: 21 },
  { cat: 'مسار الخدمات الحكومية', name: 'مساعد إسعاد المتعاملين', by: 'راشد النيادي', feats: ['يجيب عن الاستفسارات على مدار الساعة', 'يوجّه الطلبات للجهة المعنية', 'يقيس رضا المتعاملين'], rate: '4.6', sat: '97%', rev: 52 },
  { cat: 'مسار الخدمات الحكومية', name: 'مساعد الإجازات والحضور', by: 'محمد الكعبي', feats: ['يعالج طلبات الإجازات', 'يجيب عن أسئلة السياسات', 'يرصد أنماط الحضور'], rate: '4.3', sat: '93%', rev: 18 },
  { cat: 'مسار تقنيات الذكاء الاصطناعي والبيانات', name: 'مساعد الدعم الفني', by: 'عائشة الفلاسي', feats: ['يحل المشكلات الشائعة فوراً', 'يصعّد الحالات المعقدة', 'يوثّق الحلول'], rate: '4.1', sat: '92%', rev: 41 },
  { cat: 'مسار تقنيات الذكاء الاصطناعي والبيانات', name: 'مساعد أمن المعلومات', by: 'حمدان الظاهري', feats: ['يرصد التهديدات', 'يقيّم الثغرات', 'ينبّه الفرق المعنية'], rate: '4.9', sat: '99%', rev: 15 },
  { cat: 'مسار العمليات والدعم المؤسسي', name: 'مساعد التدقيق المالي', by: 'سلطان المهيري', feats: ['يراجع المعاملات آلياً', 'يكشف الحالات الشاذة', 'يولّد تقارير التدقيق'], rate: '4.7', sat: '98%', rev: 22 },
  { cat: 'مسار بناء القدرات والتدريب', name: 'مساعد التدريب والتأهيل', by: 'عبدالله الحمادي', feats: ['يقترح مسارات تعلم مخصصة', 'يتابع تقدم المتدربين', 'يقيس أثر التدريب'], rate: '4.5', sat: '96%', rev: 14 },
];
...
const ENTS: Record<string, string> = { 'سعيد النعيمي': 'وزارة شؤون مجلس الوزراء', 'أحمد المنصوري': 'الأمانة العامة للجنة الوطنية', 'مريم السويدي': 'وزارة الاقتصاد والسياحة', 'فاطمة الزعابي': 'الهيئة الاتحادية للموارد البشرية الحكومية', 'نورة القبيسي': 'وزارة المالية', 'لطيفة المزروعي': 'وزارة العدل', 'شمّا الحوسني': 'المركز الاتحادي للتنافسية والإحصاء', 'خالد الشامسي': 'وزارة الطاقة والبنية التحتية', 'راشد النيادي': 'وزارة الداخلية', 'محمد الكعبي': 'الهيئة الاتحادية للموارد البشرية الحكومية', 'عائشة الفلاسي': 'الهيئة العامة لتنظيم قطاع الاتصالات', 'حمدان الظاهري': 'مجلس الأمن السيبراني', 'سلطان المهيري': 'وزارة المالية', 'عبدالله الحمادي': 'البرنامج الوطني للذكاء الاصطناعي' };
