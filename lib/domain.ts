...
export const DEFAULT_ABOUT: AboutContent = {
  ...
  tracks: [
    { title: 'الخدمات الحكومية', desc: 'تحويل الخدمات وباقات الخدمات لتطبيق نماذج وأنظمة الذكاء الاصطناعي المساعد' },
    { title: 'العمل الحكومي الاستراتيجي', desc: 'تحويل المهام الاستراتيجية لتطبيق نماذج وأنظمة الذكاء الاصطناعي المساعد' },
    { title: 'العمليات والدعم المؤسسي', desc: 'تحويل العمليات التخصصية وعمليات الدعم المؤسسي لتطبيق نماذج وأنظمة الذكاء الاصطناعي المساعد' },
    { title: 'بناء القدرات والتدريب', desc: 'تطوير وتأهيل الموظفين الحكوميين في مجال الذكاء الاصطناعي المساعد' },
    { title: 'تقنيات الذكاء الاصطناعي والبيانات', desc: 'تطوير المنظومة التقنية والبنية التحتية للذكاء الاصطناعي المساعد' },
  ],
  scope: [
    { title: 'الإجراءات الحكومية', desc: 'الإجراءات والمعاملات الحكومية الداخلية والمشتركة بين الجهات الاتحادية.' },
    { title: 'العمليات', desc: 'العمليات التخصصية وعمليات الدعم المؤسسي في الجهات الاتحادية.' },
    { title: 'الخدمات الحكومية', desc: 'الخدمات وباقات الخدمات المقدمة للأفراد والجهات عبر مساعدي الذكاء الاصطناعي.' },
    { title: 'المهام الاستراتيجية', desc: 'المهام الاستراتيجية والأنشطة المرتبطة بها في العمل الحكومي.' },
  ],
  outOfScope:
