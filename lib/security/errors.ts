...
export const messages = {
  ...
  duplicate: 'القيمة المدخلة مسجلة مسبقاً لسجل آخر.',
  duplicateEmail: 'هذا البريد الإلكتروني مسجل لمستخدم آخر — يمكن تعديل حسابه من القائمة بدل إضافته من جديد.',
  badReference: 'الجهة أو المسار المحدد غير موجود في قاعدة البيانات.',
  cannotDeleteSelf: 'لا يمكن حذف حسابك الذي تعمل به الآن.',
};
